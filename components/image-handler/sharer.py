...
def me(event, context):
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td width="40%" class="logo" style="text-align: right;">
                                            <a href="https://www.facebook.com/sharer/sharer.php?u={{image_url_escaped}}">
                                                <img width="32"
                                                    height="32"
                                                    src="https://selfie2anime.com/email/facebook.png"
                                                    alt="Share on Facebook">
                                            </a>
                                            <a href="https://twitter.com/intent/tweet?url={{image_url_escaped}}&text=Hey, this is me as an anime character!&hashtags=selfie2anime"
                                            target="_blank">
                                                <img width="32"
                                                    height="32"
                                                    src="https://selfie2anime.com/email/twitter.png"
                                        ...
                                        <td>
                                            <div class="text" style="text-align: center">
                                                <img width="440" height="440"
                                                    src="https://selfie2anime.com/outgoing/$uuid.jpg"
                        ...
                        <tr>
                            <td class="bg_white email-section">
                                <div class="heading-section" style="text-align: center; padding: 0 30px;">
                                    ...
                                    <p>Be sure to <b>share it</b> on social media!</p>
                                </div>
                                <table width="50%">
                                    <tr>
                                        <td>
                                            <div class="text" style="text-align: center">
                                                <a href="https://www.facebook.com/sharer/sharer.php?u=https://selfie2anime.com/outgoing/$uuid.jpg">
                                                    <img width="64"
                                                        height="64"
                                                        src="https://selfie2anime.com/email/facebook.png"
                                                        alt="Share on Facebook">
                                        ...
                                        <td>
                                            <div class="text" style="text-align: center">
                                                <a href="https://twitter.com/intent/tweet?url=https://selfie2anime.com/outgoing/$uuid.jpg&text=Hey, this is me as an anime character!&hashtags=selfie2anime"
                                                target="_blank">
                                                    <img width="64"
                                                        height="64"
                                                        src="https://selfie2anime.com/email/twitter.png"
    ...
    ''')
    html_body = content.substitute(uuid=uuid)
